...
class HomeDrawer extends Component {
    ...
    state = {
        //ret : "https://i.postimg.cc/V68kf1TD/d.png"
            ...
            <Drawer.Navigator initialRouteName="Home">
                ...
                <Drawer.Screen name="|" component={AvatarScreen}
                    ...
                    options={{
                        ...
                        drawerIcon: () =>
                            <Ionicons name="add-circle-outline" size={30} color="#8CBBF1" onPress={() => this.changepika} />
                ...
                <Drawer.Screen name="Home" component={Home} initialParams={{ itemId: 42 }}
                    options={{
                        drawerLabel: "Home",
                        drawerIcon: () => <Ionicons name="home-outline" size={30} color="#8CBBF1" />,
                    }}
                />
                <Drawer.Screen name="Parent's Assistance" component={Home} initialParams={{ itemId: 42 }}
                    options={{
                ...
                />
                <Drawer.Screen name="Assess Child" component={Home} initialParams={{ itemId: 42 }}
